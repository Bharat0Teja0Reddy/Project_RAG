...
- 👁️ **Image & OCR Processing:** Upload images (`.png`, `.jpg`) and scanned documents. AirGap AI uses Tesseract OCR and the LLaVA vision model to extract and comprehend visual data.
...
1. Clone this repository to your local machine:
   ```bash
   git clone https://github.com/your-username/airgap-ai.git
   cd airgap-ai
   ```
...
3. **Start the application!**
   Simply double-click the `Start_NeuroNest.bat` file, or run the server manually:
   ```bash
